...
ADMIN_PASSWORD = "Kpmg@2025"  # Or use st.secrets["admin_password"]
...
if mode == "User":
    ...
    if st.button("Submit Feedback"):
        if trainer_name.strip() == "" or subject_name.strip() == "":
            ...
            save_feedback(trainer_name.strip(), subject_name.strip(), subject_hours,
